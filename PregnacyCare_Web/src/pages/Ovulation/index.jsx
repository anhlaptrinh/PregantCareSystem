                    ...
                    <Row className="text-center">
                        ...
                        {days.map((day, i) => {
                            ...
                            if (isOvulationDay(day)) bgClass = "bg-info";
                                ...
                                bgClass = "bg-warning bg-opacity-50";
    ...
    return (
        ...
        >
            ...
            <Paragraph className="mb-4">
                Use our ovulation calculator to predict when you might ovulate
                and boost your chances of getting pregnant. This tool helps you
                pinpoint your likely ovulation date and your most fertile window
                to set you up for baby-making success!
            </Paragraph>
            ...
            {!showResults ? (
                ...
                <div>
                    ...
                    <div className="mt-4 pt-4 border-top">
                        <Paragraph>
                            Most couples get pregnant within three months. If
                            you try for a year without success (or six months if
                            you're 35 or older), seek help from a{" "}
                            <a
                                href="#"
                            ...
                            <ul className="list-unstyled">
                                <li className="d-flex gap-2 mb-3">
                                    ...
                                    <Paragraph className="m-0">
                                        Find out when you'll ovulate using our
                                        calculator or an ovulation predictor
                                        kit, or by tracking your symptoms.
                                    </Paragraph>
                                </li>
                                <li className="d-flex gap-2 mb-3">
                                    <div
                                    ...
                                    />
                                    <Paragraph className="m-0">
                                        Have sex every other day around the time
                                        of ovulation.
                                    </Paragraph>
                                </li>
                                <li className="d-flex gap-2 mb-3">
                                    ...
                                    <Paragraph className="m-0">
                                        ...
                                        folic acid at least one month before you
                                        start trying (6 months is ideal).
                                    </Paragraph>
                                </li>
                                <li className="d-flex gap-2 mb-3">
                                    <div
                                    ...
                                    />
                                    <Paragraph className="m-0">
                                        See your healthcare provider and make
                                        sure they're managing any pre-existing
                                        health conditions you may have. Staying
                                        up-to-date with vaccinations and regular
                                        check-ups can lower the risk of
                                ...
                                <li className="d-flex gap-2 mb-3">
                                    ...
                                    />
                                    <Paragraph className="m-0">
                                        Take good care of yourself. You'll want
                                        to kick unhealthy habits like smoking
                                        and start incorporating regular exercise
                                        into your routine if you aren't
                                        exercising already. Eating a healthy,
                                        nutrient-dense diet can help, too.
                                    </Paragraph>
                                </li>
                            </ul>
                        </section>
                    ...
                    <div className="col-12 my-5">
                        <section>
                            ...
                            <Paragraph className="mb-3">
                                In addition to using an ovulation calculator,
                                here are ways that moms in the BabyCenter
                                Community know they're ovulating:
                            </Paragraph>
                            <div className="d-flex flex-column gap-3">
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        "I usually get ovulation cramping or
                                        pain on my left side" – mommy1johnson
                                    </p>
                                </blockquote>
                                <blockquote
                                    className="blockquote border-start border-info ps-3"
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        "My ovulation signs are cervical mucus
                                        that looks like egg whites; occasional,
                                        very mild, one-sided ovarian discomfort;
                                        a higher sex drive; and increased
                                        appetite." – krt1987
                                    </p>
                                </blockquote>
                                <blockquote
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        "I get bloated and my lower abdomen
                                        feels very sore." – Kmarvin91
                                    </p>
                                </blockquote>
                                <blockquote
                                    className="blockquote border-start border-info ps-3"
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        "My BBT typically rises incrementally
                                        over three days, for a total rise of .8
                                        or .9 over pre-ovulation temperatures."
                                        – Rikkubug
                                    </p>
                                </blockquote>
                                <blockquote
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        ...
                                        and had an increase in body temperature
                                        and lower back pain on the left side." –
                                        Newwifelife
                                    </p>
                                </blockquote>
                                <blockquote
                                ...
                                >
                                    <p className="fst-italic mb-0">
                                        "I have slight bloating, increased
                                        appetite, and light cramps like the ones
                                        I get before my period. Plus, I'm in a
                        ...
                        <section>
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li className="d-flex gap-2 mb-3">
                                    ...
                                    />
                                    <Paragraph className="m-0">
                                        Cervical mucus is the texture of egg
                                        whites
                                    </Paragraph>
                                </li>
                                <li className="d-flex gap-2 mb-3">
                            ...
                            <div className="d-flex flex-column gap-3">
                                    ...
                                    {activeKey.includes("1") && (
                                        <div className="p-3">
                                            <Paragraph>
                                                ...
                                                ovaries releases an egg. This
                                                egg travels down the fallopian
                                                tube where it may be fertilized
                                                by sperm.
                                            </Paragraph>
                                        </div>
                                    )}
                                ...
                                <div className="border rounded">
                                    ...
                                    {activeKey.includes("2") && (
                                        <div className="p-3">
                                            <Paragraph>
                                                Most women ovulate about 14 days
                                                before their period starts. In a
                                                typical 28-day cycle, this would
                                                be around day 14.
                                            </Paragraph>
                                        </div>
                                    )}
                                ...
                                <div className="border rounded">
                                    ...
                                    {activeKey.includes("3") && (
                                        <div className="p-3">
                                            <Paragraph>
                                                You can track your basal body
                                                temperature, observe changes in
                                                cervical mucus, use ovulation
                                                predictor kits, or notice
                                                physical symptoms like mild
                                                cramping or increased sex drive.
                                            </Paragraph>
                                        </div>
                                    )}
                                </div>
                                    ...
                                    {activeKey.includes("4") && (
                                        <div className="p-3">
                                            <Paragraph>
                                                ...
                                                cramping, bloating, breast
                                                tenderness, or increased sex
                                                drive. Others may not feel
                                                anything at all.
                                            </Paragraph>
                                        </div>
                                    )}
                                ...
                                <div className="border rounded">
                                    ...
                                    {activeKey.includes("5") && (
                                        <div className="p-3">
                                            <Paragraph>
                                                The egg is only viable for about
                                                24 hours after it's released.
                                                However, sperm can live in the
                                                female reproductive tract for up
                                                to 5 days, so your fertile
