  ...
  return (
    <div>
      <div className="mt-8 text-left">
        <h3 className="font-bold">BabyCenter's Due Date Calculator</h3>
        ...
        <h3 className=" font-bold  mt-6">How is my due date calculated?</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">First day of your last period</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">Conception date</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">IVF transfer date</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">Ultrasound scan</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">Can my due date change?</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">What if I already know my due date?</h3>
        <p className="fs-3 mt-2">
        ...
        <h3 className="font-bold">How soon can I take a pregnancy test?</h3>
        <p className="fs-3 mt-2">
        ...
        <p className="fs-3 mt-2">
          ...
          moms experienced:{" "}
          <ul className="list-disc list-outside pl-5 mt-6">
            <li>
              “My first two were both two weeks late (I had to be induced) and
              my third was exactly a week early.” – Bremgoe91
            </li>
            <li>
              “I have four kids, and they came on their due date or a day before
              or after.” – 8Daisy
            </li>
            <li>
              “Both my sons went to 41 weeks and two days. I thought I was going
              to be pregnant forever.” – GothHoney87
            </li>
            <li>
              “With my first, everyone told me I was going to go past my due
              date, but I went into labor at 38 weeks and five days.” –
              Hannahkovachick
            </li>
            <li>
              “My first came on his due date; my second came a week late.” –
              Ninalynn05
            </li>
          </ul>
        </p>
